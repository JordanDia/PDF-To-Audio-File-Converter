...
__all__ = [
    'SPEI_PHONEME', 'DISPID_SVWaitUntilDone', 'SPPHRASEELEMENT',
    'SAFTDefault', 'SP_VISEME_7', 'SpeechAudioFormatGUIDWave',
    'ISpeechAudioBufferInfo', 'SPAUDIOSTATUS',
    'SPEI_FALSE_RECOGNITION', 'SVEViseme', 'DISPID_SOTs_NewEnum',
    'SpeechCategoryAudioIn', 'SPEI_MAX_TTS', 'STSF_FlagCreate',
    'SAFT48kHz16BitStereo', 'DISPID_SPRuleName', 'SpeechDiscardType',
    'IInternetSecurityMgrSite', 'DISPID_SLWPronunciations',
    'SpCompressedLexicon', 'SpeechUserTraining', 'SPPS_Unknown',
    'DISPID_SGRsFindRule', 'DISPID_SRRPhraseInfo', 'SITooQuiet',
    'DISPID_SLGetPronunciations', 'SpeechCategoryPhoneConverters',
    'SpeechRecoContextState', 'SPSERIALIZEDPHRASE', 'SVP_2',
    'SGRSTTWord', 'DISPID_SGRsCount', 'SPFM_CREATE', 'DISPIDSPTSI',
    'SPEI_RECO_OTHER_CONTEXT', 'SpInProcRecoContext',
    'DISPID_SPCLangId', 'DISPID_SPPParent', 'ISpeechAudioFormat',
    'SpeechVisemeType', 'SPPS_RESERVED1', 'DISPID_SWFEBlockAlign',
    'SPRST_NUM_STATES', 'DISPID_SGRSTs_NewEnum',
    'SpeechVoiceCategoryTTSRate', 'SLOStatic', 'DISPID_SPEsItem',
    'SAFTADPCM_44kHzStereo', 'STSF_CommonAppData', 'SVSFParseSapi',
    'DISPID_SOTRemove', 'SAFT22kHz16BitStereo',
    'DISPID_SVAudioOutputStream', 'SPINTERFERENCE_TOOSLOW',
    'SECFEmulateResult', 'SAFT16kHz8BitMono',
    'DISPID_SPAStartElementInResult', 'SDTProperty', 'SpMMAudioEnum',
    'DISPID_SPANumberOfElementsInResult', 'SPCS_DISABLED',
    'DISPID_SRRTLength', 'DISPIDSPTSI_SelectionLength', 'SPSUnknown',
    'UINT_PTR', 'ISpeechObjectTokenCategory', 'SDTAudio',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_TTS_PRIVATE',
    'STCInprocServer', 'SPINTERFERENCE_TOOFAST', 'DISPID_SAStatus',
    'SpSharedRecoContext', 'DISPID_SRCResume', 'ISpPhrase', 'SVP_19',
    'SpeechDictationTopicSpelling', 'DISPID_SPIStartTime',
    'Speech_Default_Weight', 'SPRS_ACTIVE', 'DISPID_SBSRead',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRAttributes', 'SVP_16',
    'SpAudioFormat', 'DISPID_SpeechRecoResult', 'SP_VISEME_1',
    'SRTEmulated', 'SAFTADPCM_8kHzMono', 'DISPID_SPPValue',
    'DISPID_SRGetPropertyNumber', 'tagSTATSTG', 'DISPID_SVEViseme',
    'SPTEXTSELECTIONINFO', 'SPPS_Function', 'SRSInactive',
    ...
    'SDA_Consume_Leading_Spaces', 'SPXRO_SML', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRuleEngineConfidence', 'SRCS_Disabled',
    'SpeechVoiceEvents', 'SREAllEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SREmulateRecognition',
    'DISPID_SRCreateRecoContext', 'DISPID_SVGetProfiles',
    'DISPID_SABIEventBias', 'SpeechWordPronounceable', 'SPSModifier',
    'DISPID_SPPsItem', 'DISPID_SVGetVoices',
    'DISPID_SPRuleFirstElement', 'DISPID_SRRDiscardResultInfo',
    'SAFT8kHz16BitStereo', 'SSTTWildcard', 'DISPID_SVEStreamStart',
    'SPGS_EXCLUSIVE', 'SPAR_Medium', 'DISPID_SPEAudioSizeBytes',
    'SDA_Two_Trailing_Spaces', 'SVP_21', 'DISPID_SGRSTText',
    'SASPause', 'ISpeechLexiconWords', 'ISpGrammarBuilder',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SDKSetLongValue', 'SRAExport',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_PRIVATE1', 'SAFT16kHz16BitStereo', 'ISpVoice',
    'SPPS_RESERVED3', 'SPRULE', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechGrammarRules',
    'SWPUnknownWordUnpronounceable', 'SpWaveFormatEx',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SLWType', 'SPVPRI_NORMAL',
    'SREBookmark', 'DISPID_SPRsItem', 'DISPID_SDKSetStringValue',
    'DISPID_SRGDictationLoad', 'SDKLLocalMachine', 'SpeechRunState',
    'SPCS_ENABLED', 'SVP_0', 'SVP_10',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPDKL_CurrentConfig',
    'DISPID_SWFESamplesPerSec', 'STCInprocHandler',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechDataKey', 'SECFIgnoreWidth',
    'SP_VISEME_0', 'SFTInput', 'SPFILEMODE', 'DISPIDSPRG',
    'ISpDataKey', 'DISPID_SRIsShared', 'DISPID_SPRuleParent',
    'SVSFNLPMask', 'DISPID_SVEStreamEnd', 'eLEXTYPE_USER',
    'SPFM_OPEN_READONLY', 'SpeechDisplayAttributes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechAudio', 'eLEXTYPE_PRIVATE18', 'SPCT_COMMAND',
    'DISPID_SLPType', 'DISPID_SGRsCommitAndSave', 'DISPID_SGRSTType',
    'DISPID_SWFEFormatTag', 'ISpeechDataKey',
    'SAFTExtendedAudioFormat', 'SpeechRuleAttributes',
    'DISPID_SRAudioInput', 'SVSFDefault', 'DISPID_SPRText',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechBaseStream',
    'DISPID_SRRSpeakAudio', 'DISPIDSPTSI_SelectionOffset',
    'SREInterference', 'SREAudioLevel',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechGrammarRules',
    'SAFTADPCM_22kHzMono', 'DISPID_SBSFormat', 'DISPID_SPRuleId',
    'SRSActive', 'SPAS_RUN', 'DISPID_SVSVisemeId', 'SPSSuppressWord',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechCustomStream',
    'DISPID_SLGenerationId', 'SPFM_OPEN_READWRITE',
    'DISPID_SVGetAudioOutputs', 'SVSFPersistXML', 'SINone',
    'DISPID_SpeechPhoneConverter',
    'SpeechPropertyComplexResponseSpeed', 'SpPhoneConverter',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCERecognition',
    'SINoise', 'DISPID_SPRFirstElement', 'SGDSActiveUserDelimited',
    'SVESentenceBoundary', 'eLEXTYPE_PRIVATE19',
    'SAFT11kHz16BitStereo', 'eLEXTYPE_PRIVATE16',
    'SpNotifyTranslator', 'SpeechPartOfSpeech', 'SVSFIsFilename',
    'ISpEventSink', 'DISPID_SPCIdToPhone', 'SPEI_TTS_BOOKMARK',
    'ISpeechWaveFormatEx', 'SVP_18', 'SRTSMLTimeout',
    'DISPID_SpeechRecognizerStatus', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPIRule', 'DISPID_SpeechVoiceStatus', 'ISpRecoGrammar2',
    'SPPS_RESERVED2', 'ISpeechPhraseRule', 'IEnumSpObjectTokens',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRRAudioFormat',
    'DISPID_SRSAudioStatus', 'ISpeechPhraseInfoBuilder',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_RESERVED4', 'SAFTNonStandardFormat',
    'ISpeechPhraseProperty', 'SPSNoun', 'SECLowConfidence',
    'SPWORDPRONOUNCEABLE', 'SAFT12kHz8BitMono', 'DISPID_SRRAudio',
    'DISPID_SLPsItem', 'SAFT12kHz16BitStereo', 'SpPhraseInfoBuilder',
    'SPAR_Unknown', 'DISPID_SOTId', 'SAFT11kHz8BitStereo',
    'SPDKL_LocalMachine', 'SREFalseRecognition', 'ISpeechRecognizer',
    'SREPrivate', 'eLEXTYPE_PRIVATE9', 'DISPID_SDKDeleteValue',
    'SPPS_Verb', 'SPEVENTENUM', 'DISPID_SRCCmdMaxAlternates',
    'SSSPTRelativeToStart', 'SAFT22kHz8BitMono',
    'ISpeechPhraseProperties', 'SREPropertyNumChange',
    'DISPID_SpeechMemoryStream', 'DISPID_SWFEBitsPerSample',
    'DISPID_SDKEnumValues', 'DISPID_SOTCGetDataKey', 'SREPhraseStart',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRGetRecognizers',
    'SPSLMA', 'SSSPTRelativeToEnd', 'SVPAlert', 'STSF_LocalAppData',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseElement', 'ISpPhoneticAlphabetConverter',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechTokenKeyFiles',
    'SpTextSelectionInformation', 'SPEI_SR_BOOKMARK', 'SPGS_DISABLED',
    'SPINTERFERENCE_NONE', 'DISPID_SPRuleConfidence',
    'DISPID_SRGState', 'ISpeechPhraseReplacement',
    'SpeechStreamFileMode', 'SPAUDIOOPTIONS', 'SVEStartInputStream',
    'eWORDTYPE_DELETED', 'SPPS_RESERVED4',
    ...
    'SAFT8kHz8BitMono', 'DISPID_SRGRules', 'DISPID_SOTCategory',
    'DISPID_SRRSaveToMemory', 'SRARoot', 'SVEWordBoundary',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SVEventInterests',
    'SpeechAudioFormatGUIDText', '_ISpeechVoiceEvents',
    'SVSFPurgeBeforeSpeak', 'ISpStreamFormatConverter', 'SPVISEMES',
    'SpSharedRecognizer', 'DISPID_SASCurrentSeekPosition',
    'SWPUnknownWordPronounceable', 'DISPID_SGRId', 'STCLocalServer',
    'DISPID_SGRSAddWordTransition', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRSAddSpecialTransition',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRCSetAdaptationData',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRGCmdLoadFromMemory',
    'SVSFlagsAsync', 'ISpRecoCategory', 'SpeechRetainedAudioOptions',
    'DISPID_SGRClear', 'STCAll', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGDictationSetState', 'SpeechTokenContext',
    'DISPID_SLWWord', 'ISpeechPhraseInfo', 'SPFM_NUM_MODES',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPRuleChildren',
    'DISPID_SRStatus', 'DISPID_SDKCreateKey', 'SVP_14',
    'DISPID_SPRDisplayAttributes', 'SpLexicon', 'SAFT12kHz8BitStereo',
    'DISPID_SRRGetXMLErrorInfo', 'SAFT12kHz16BitMono',
    'ISpNotifySource', 'ISpStream', 'SSFMCreate',
    'DISPID_SPEPronunciation', 'SPVPRI_OVER', 'SPEI_END_INPUT_STREAM',
    'SpeechGrammarTagUnlimitedDictation', 'SPAS_STOP', 'SRAImport',
    'SGLexicalNoSpecialChars', 'SPRST_INACTIVE_WITH_PURGE',
    '__MIDL_IWinTypes_0009', 'SpeechVoiceSpeakFlags',
    'DISPID_SPAs_NewEnum', 'SPEI_SOUND_END', 'SPEI_RECOGNITION',
    'SPRS_INACTIVE', 'DISPID_SRCEEnginePrivate',
    'SpeechPropertyResourceUsage', 'SITooSlow',
    'DISPID_SpeechAudioFormat', 'SAFT44kHz8BitMono', 'SREStreamStart',
    '_SPAUDIOSTATE', 'SpeechAddRemoveWord', 'DISPID_SVIsUISupported',
    'SASStop', 'SDTReplacement', 'SpeechBookmarkOptions',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPIAudioStreamPosition',
    'SPWF_SRENGINE', 'SGRSTTRule', 'DISPID_SRRTimes', 'SPLOADOPTIONS',
    'SpeechRecoEvents', 'SASRun', 'eLEXTYPE_RESERVED8',
    'SPEI_START_INPUT_STREAM', 'SPBO_NONE', 'SPCATEGORYTYPE',
    'SAFTNoAssignedFormat', 'DISPID_SPPBRestorePhraseFromMemory',
    'SRAONone', 'SpMMAudioOut', 'tagSPPROPERTYINFO', 'SRESoundStart',
    'ISpeechGrammarRuleState', 'DISPID_SLPLangId',
    'SAFT22kHz8BitStereo', 'Speech_Max_Word_Length',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRSNumberOfActiveRules',
    'SVEPhoneme', 'DISPID_SMSALineId', 'SAFT8kHz8BitStereo',
    'DISPID_SRGDictationUnload', 'ISpRecoGrammar',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFIsXML',
    'DISPID_SpeechRecognizer', 'SPSHORTCUTPAIRLIST',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRSClsidEngine', 'DISPID_SFSClose',
    'DISPID_SpeechMMSysAudio', 'SPPARTOFSPEECH',
    'DISPID_SPIEnginePrivateData', 'SpeechAudioFormatType',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRulesCount', 'SVP_1',
    'SpeechSpecialTransitionType', 'DISPID_SpeechRecoResultTimes',
    'SPAO_NONE', 'ISpEventSource', 'SPSERIALIZEDRESULT',
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_3',
    'SPEI_START_SR_STREAM', 'SVP_8', 'ISpeechResourceLoader',
    'ISpShortcut', 'DISPID_SVSpeak', 'SRADefaultToActive',
    'DISPID_SVAudioOutput', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechRecoResult2', 'SAFTCCITT_uLaw_44kHzMono',
    'SPWORDLIST', 'SECFDefault', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVESentenceBoundary',
    'SPEI_MIN_TTS', 'DISPID_SMSADeviceId', 'eLEXTYPE_USER_SHORTCUT',
    'SPCT_SUB_COMMAND', 'DISPID_SAVolume',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPIGrammarId',
    'DISPID_SAFType', 'STCRemoteServer', 'DISPID_SGRSTRule',
    'SPWORDTYPE', 'eLEXTYPE_PRIVATE2', 'SRADynamic',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTCId',
    'DISPID_SPIProperties', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCEEndStream', 'SAFTCCITT_ALaw_44kHzStereo',
    'SWPKnownWordPronounceable', 'SGRSTTWildcard',
    'DISPID_SPRulesItem', 'ISpResourceManager',
    'DISPID_SGRSTPropertyName', 'DISPID_SOTGetDescription',
    'SPVOICESTATUS', 'SRTExtendableParse', 'SVP_3',
    'DISPID_SRGetPropertyString', 'SpeechCategoryAppLexicons',
    'SpeechEngineConfidence', 'SPFM_CREATE_ALWAYS',
    'SpeechLexiconType', 'SSFMOpenReadWrite', 'SAFT48kHz8BitStereo',
    'SPCT_SLEEP', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SVVolume', 'DISPID_SRAudioInputStream', 'SBOPause',
    'DISPID_SVSpeakStream', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechAllElements', 'DISPID_SOTIsUISupported', 'SDKLCurrentUser',
    'SpNullPhoneConverter', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechGrammarWordType', 'SAFT16kHz16BitMono',
    'DISPID_SADefaultFormat', 'DISPID_SRGCommit', 'SP_VISEME_19',
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_PRIVATE7', 'SRSActiveAlways',
    'DISPID_SRCEInterference', 'DISPID_SGRSTsItem', 'DISPID_SGRName',
    'ISpeechPhraseReplacements', 'DISPID_SPIGetText',
    'SRAORetainAudio', 'SP_VISEME_9', 'DISPID_SRCVoice',
    'SAFT32kHz8BitMono', 'SAFT8kHz16BitMono', 'SAFT48kHz8BitMono',
    'DISPID_SPPsCount', 'ISpAudio', 'SP_VISEME_17', 'SPEI_MIN_SR',
    'SVSFParseSsml', 'DISPID_SRCRetainedAudioFormat', 'SSTTDictation',
    'DISPID_SOTsItem', 'SPEI_ADAPTATION',
    'DISPID_SRCEPropertyNumberChange', 'SLODynamic', 'SPWORD',
    'ISpeechPhraseRules', 'SpeechCategoryRecoProfiles',
    'DISPID_SASState', 'SPSHORTCUTPAIR', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechCustomStream', 'SVP_9', 'DISPID_SPEDisplayAttributes',
    'SpeechTokenShellFolder', 'ISpObjectTokenCategory',
    'eLEXTYPE_PRIVATE5', 'SpStreamFormatConverter',
    'SAFT44kHz8BitStereo', 'DISPID_SDKSetBinaryValue', 'SVPNormal',
    'DISPID_SVGetAudioInputs', 'SRESoundEnd', 'DISPID_SFSOpen',
    'SAFTADPCM_11kHzMono', 'DISPID_SRDisplayUI', 'SPEI_RESERVED1',
    'SVEVoiceChange', 'Speech_Max_Pron_Length', 'SPDATAKEYLOCATION',
    'DISPID_SRCESoundStart', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SWFEExtraData', 'DISPID_SOTDisplayUI',
    'SPEI_TTS_AUDIO_LEVEL', 'SREPropertyStringChange',
    'DISPID_SRCBookmark', 'SpeechMicTraining',
    'DISPID_SRRTStreamTime', 'ISpeechRecoResult', 'SVP_6',
    'SPEI_MAX_SR', 'SpCustomStream', 'DISPID_SPIAudioSizeBytes',
    'SPBO_PAUSE', 'SpInprocRecognizer', 'SPBOOKMARKOPTIONS', 'SVP_4',
    'SPSFunction', 'SGDSActiveWithAutoPause', 'IStream',
    'DISPID_SPPs_NewEnum', 'SDKLCurrentConfig',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechPhraseRules',
    'DISPID_SABufferInfo', 'eLEXTYPE_PRIVATE12',
    'SpeechDataKeyLocation', 'eLEXTYPE_PRIVATE3', 'STSF_AppData',
    'ISpLexicon', 'ISpPhraseAlt', 'DISPID_SMSGetData',
    'SPEI_INTERFERENCE', 'SPSHT_Unknown', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRCERequestUI', 'SPRECORESULTTIMES',
    'DISPID_SVSLastBookmark', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SGRSTransitions', 'DISPID_SCSBaseStream',
    'DISPID_SLWLangId', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE14', 'SSSPTRelativeToCurrentPosition',
    'SRTStandard', 'SLTApp', 'SpeechPropertyResponseSpeed',
    'SPSEMANTICERRORINFO', 'DISPID_SVStatus', 'SSFMCreateForWrite',
    '_RemotableHandle', 'DISPID_SPRNumberOfElements',
    'DISPID_SVEEnginePrivate', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCRecognizer', 'DISPID_SLPs_NewEnum',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGetFormat', 'SP_VISEME_14', 'DISPID_SGRSTPropertyId',
    'SRSEIsSpeaking', 'SECFNoSpecialChars', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechRecoContext', 'DISPID_SPRs_NewEnum',
    'SpeechWordType', 'SpeechAudioProperties', 'SREAdaptation',
    'DISPID_SRRAlternates', 'ISpeechMemoryStream',
    'ISpeechMMSysAudio', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPIReplacements', 'DISPID_SRState',
    'DISPID_SPPConfidence', 'SVP_20', 'DISPID_SRCRequestedUIType',
    'SRERecognition', 'eWORDTYPE_ADDED',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_LETTERTOSOUND',
    'SPRST_INACTIVE', 'SPRST_ACTIVE_ALWAYS', 'SPPS_Noun',
    'SRERequestUI', 'DISPID_SRCESoundEnd', 'ISpeechPhraseAlternates',
    'DISPID_SPELexicalForm', 'DISPID_SPAPhraseInfo',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_RESERVED6', 'SPEI_SR_PRIVATE',
    'SINoSignal', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechRecognitionType', 'DISPID_SRGRecoContext',
    'SpeechRegistryLocalMachineRoot', 'SPWT_LEXICAL',
    'SPEI_RESERVED2', 'SPEI_SOUND_START', 'SWTAdded', 'ISpeechAudio',
    'SpObjectToken', 'DISPID_SLAddPronunciationByPhoneIds',
    'Speech_StreamPos_RealTime', 'SRERecoOtherContext',
    'DISPID_SPERequiredConfidence', 'DISPIDSPTSI_ActiveLength',
    'SPPHRASE', 'DISPID_SVDisplayUI', 'SAFT24kHz8BitMono',
    'DISPID_SLPsCount', 'SPAR_Low', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPRsCount', 'DISPID_SRGCmdLoadFromFile', 'SPAUDIOSTATE',
    'SPVPRI_ALERT', 'DISPID_SRCEBookmark', 'SRTAutopause',
    'DISPID_SRCPause', 'DISPID_SBSWrite', 'SPWT_DISPLAY',
    'SAFT32kHz16BitMono', 'SPGS_ENABLED', 'DISPID_SRCEPhraseStart',
    'ISpNotifyTranslator', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPERetainedSizeBytes', 'SASClosed',
    '_ISpeechRecoContextEvents', 'DISPID_SRCCreateResultFromMemory',
    'SFTSREngine', 'DISPID_SRProfile', 'DISPID_SOTGetAttribute',
    'SP_VISEME_12', 'DISPID_SVResume', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SOTsCount', 'ISpObjectToken', 'SPEI_RESERVED5',
    'ISpeechLexiconPronunciation', 'DISPID_SAEventHandle',
    'SPRECOGNIZERSTATUS', 'DISPID_SDKGetStringValue', 'SAFTText',
    'SAFTCCITT_uLaw_44kHzStereo', 'SREHypothesis',
    'DISPID_SLAddPronunciation', 'SGDSInactive', 'SP_VISEME_20',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_APP', 'SPRS_ACTIVE_USER_DELIMITED',
    'SDTDisplayText', 'eLEXTYPE_PRIVATE17', 'SRCS_Enabled',
    'SGLexical', 'SVP_11', 'ISpRecognizer2', 'DISPID_SBSSeek',
    'ISpeechObjectTokens', 'SPAO_RETAIN_AUDIO', 'SPEI_END_SR_STREAM',
    'SpeechLoadOption', 'DISPID_SOTGetStorageFileName',
    'ISpeechRecoResult2', 'SP_VISEME_10', 'SITooLoud',
    'DISPID_SABufferNotifySize', 'SVSFParseMask',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechFormatType',
    'SPSInterjection', 'ISpNotifySink', 'DISPID_SVSLastBookmarkId',
    'SPBO_AHEAD', 'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRSTNextState', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechObjectTokens', 'DISPID_SGRInitialState', 'SVP_17',
    'SPEI_PHRASE_START', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SLPPhoneIds', 'ISpeechGrammarRuleStateTransition',
    'ISpSerializeState', 'DISPID_SPPChildren', 'DISPID_SLGetWords',
    'SPADAPTATIONRELEVANCE', 'SPPS_NotOverriden',
    'SpeechTokenValueCLSID', 'SRSEDone', 'DISPID_SRIsUISupported',
    'DISPID_SMSAMMHandle', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechVoice', 'ISpXMLRecoResult', 'ISpeechObjectToken',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SGRSRule',
    'SDA_One_Trailing_Space', 'SPPHRASEPROPERTY', 'DISPID_SVPause',
    'SPRULESTATE', 'ISpeechTextSelectionInformation', 'SpShortcut',
    'DISPID_SpeechGrammarRule', 'DISPID_SAFGuid',
    'DISPID_SOTCEnumerateTokens', 'SpeechGrammarTagWildcard',
    'DISPID_SPEDisplayText', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SABIMinNotification', 'ISpeechRecognizerStatus',
    'DISPID_SGRAddResource', 'DISPID_SGRs_NewEnum',
    'SPINTERFERENCE_NOSIGNAL', 'SpStream', 'SRATopLevel',
    'SPPS_Interjection', 'SPEI_SENTENCE_BOUNDARY', 'ISpRecognizer3',
    'ISpeechRecoContext', 'DISPID_SLPPartOfSpeech', 'SGSEnabled',
    'DISPID_SpeechPhraseRule', 'DISPID_SVVoice', 'SPSHT_NotOverriden',
    'SPSMF_UPS', 'SRAInterpreter', 'DISPID_SVEPhoneme',
    'SPWT_PRONUNCIATION', 'SpeechRecognizerState',
    'DISPID_SPERetainedStreamOffset', 'SPSEMANTICFORMAT',
    'DISPID_SPAsCount', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPAsItem', 'SpUnCompressedLexicon',
    'DISPID_SPEAudioStreamOffset', 'SAFTCCITT_uLaw_8kHzMono',
    'SPPS_LMA', 'DISPID_SLWs_NewEnum', 'SP_VISEME_13',
    'DISPID_SpeechLexiconPronunciation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SpeechLexicon',
    'DISPID_SRGId', 'ISpeechPhoneConverter',
    'DISPID_SGRSTPropertyValue', 'SpeechAudioVolume',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPEs_NewEnum',
    'SVSFNLPSpeakPunc', 'DISPID_SRCState',
    'SpeechRecoProfileProperties', 'SECFIgnoreCase', 'SDTRule',
    'SDTLexicalForm', 'DISPID_SGRsCommit', 'DISPID_SPACommit',
    'DISPID_SOTDataKey', 'DISPID_SRGIsPronounceable',
    'SPPS_SuppressWord', 'DISPID_SWFEChannels', 'SAFT48kHz16BitMono',
    'DISPID_SRRecognizer', 'SITooFast', 'SPBINARYGRAMMAR',
    'SpeechStreamSeekPositionType', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechObjectToken', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVEAudioLevel', 'SPEVENT', 'SpeechRuleState',
    'DISPID_SVAlertBoundary', 'SVSFVoiceMask', 'DISPID_SOTCDefault',
    'DISPID_SASNonBlockingIO', 'SPEI_RESERVED6', 'eLEXTYPE_PRIVATE13',
    'SpeechRegistryUserRoot', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPS_Modifier', 'SPPS_Noncontent', 'eLEXTYPE_PRIVATE6',
    'SAFTGSM610_44kHzMono', 'ISpObjectWithToken',
    'DISPID_SPEActualConfidence', 'SpeechTokenKeyAttributes',
    'SP_VISEME_8', 'SPEVENTSOURCEINFO', 'DISPID_SVSkip',
    'DISPID_SVEWord', 'SPINTERFERENCE_TOOLOUD', 'SP_VISEME_16',
    'SP_VISEME_21', 'SVEPrivate', 'SPAR_High', 'SPCT_SUB_DICTATION',
    'SpeechGrammarState', 'ISpeechLexicon',
    'DISPID_SRSetPropertyNumber', 'SDTPronunciation',
    'ISpeechGrammarRule', 'DISPID_SPRuleNumberOfElements',
    'SVEAllEvents', 'SAFT22kHz16BitMono', 'SPCONTEXTSTATE',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRsItem', 'DISPID_SPEsCount',
    'SPCT_DICTATION', 'ISpeechVoiceStatus', 'DISPID_SDKOpenKey',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSVerb',
    'ISpeechLexiconWord', 'ISpeechPhraseElements', 'SPLEXICONTYPE',
    'DISPID_SLWsItem', 'SDTAll', 'DISPID_SPEAudioSizeTime',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPPId',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPIElements',
    'SREStreamEnd', 'SpeechTokenKeyUI', 'SGSExclusive', 'SGDSActive',
    'SpeechAudioState', 'SPAUDIOBUFFERINFO', 'SVEEndInputStream',
    'DISPID_SWFEAvgBytesPerSec', 'SPDKL_DefaultLocation',
    'DISPID_SASetState', 'DISPID_SPEEngineConfidence', 'SGSDisabled',
    ...
    'SP_VISEME_4', 'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechPhraseBuilder', 'SAFTCCITT_ALaw_8kHzStereo',
    'SGRSTTDictation', 'DISPID_SOTSetId',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPPName',
    'ISpeechAudioStatus', 'SPBO_TIME_UNITS',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE4', 'SPXMLRESULTOPTIONS', 'SPINTERFERENCE',
    'SPPHRASEREPLACEMENT', 'ISpeechXMLRecoResult', 'SVPOver',
    'DISPID_SRSCurrentStreamPosition', 'SPAS_CLOSED',
    'SPEI_VOICE_CHANGE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPPFirstElement', 'SGDisplay',
    'DISPID_SpeechPhraseReplacement', 'SPSNotOverriden',
    'SVEBookmark', 'DISPID_SMSSetData', 'SpResourceManager',
    'SSFMOpenForRead', 'SDTAlternates', 'SAFT32kHz16BitStereo',
    'SSTTTextBuffer', 'SpeechPropertyLowConfidenceThreshold',
    'SRSInactiveWithPurge', 'SGRSTTTextBuffer',
    'DISPID_SRGCmdSetRuleIdState', 'SVEAudioLevel',
    'SpeechVisemeFeature', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechXMLRecoResult', 'SpeechCategoryAudioOut',
    ...
    'SDA_No_Trailing_Space', 'DISPID_SpeechPhraseElements', 'SVP_5',
    'SPINTERFERENCE_NOISE', 'SPEI_VISEME', 'DISPID_SRRGetXMLResult',
    'DISPID_SLPSymbolic', 'DISPID_SPARecoResult', 'SPLO_STATIC',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVSRunningState',
    'DISPID_SVSInputWordPosition', 'ISpRecoResult', 'SPLO_DYNAMIC',
    'eLEXTYPE_PRIVATE8', 'DISPID_SGRsDynamic', 'SAFT11kHz8BitMono',
    'SP_VISEME_18', 'SpeechVoicePriority', 'DISPID_SPRules_NewEnum',
    'DISPID_SLWsCount', 'DISPID_SPISaveToMemory', 'SPVPRIORITY',
    'SGRSTTEpsilon', 'DISPID_SpeechFileStream', 'ISpRecoContext2',
    'SPRECOCONTEXTSTATUS', 'ISequentialStream', 'SVSFParseAutodetect',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechLexiconWord', 'ISpProperties',
    'SAFTCCITT_uLaw_11kHzMono', 'SECHighConfidence', 'SREStateChange',
    'DISPID_SDKGetBinaryValue', 'SAFT24kHz16BitStereo',
    'ISpPhoneConverter', 'SVP_13', 'DISPID_SpeechAudioStatus',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRRTTickCount',
    'SPEI_HYPOTHESIS', 'ISpRecoContext', 'DISPID_SVSLastResult',
    'SAFT11kHz16BitMono', 'SECFIgnoreKanaType', 'eLEXTYPE_PRIVATE10',
    'SRTReSent', 'DISPID_SPILanguageId', 'SVSFUnusedFlags',
    'DISPID_SDKEnumKeys', 'SGPronounciation', 'SAFT24kHz16BitMono',
    'DISPID_SLRemovePronunciation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSHT_OTHER',
    'SPXRO_Alternates_SML', 'DISPID_SRGReset', 'SBONone',
    'SVF_Stressed', 'DISPID_SRCEStartStream',
    'DISPID_SASFreeBufferSpace', 'SLTUser', 'SpeechCategoryVoices',
    'DISPID_SOTCSetId', 'DISPID_SPIEngineId', 'SpVoice', 'SWTDeleted',
    'ISpStreamFormat', 'SPEI_RESERVED3', 'SpeechCategoryRecognizers',
    'DISPID_SPIAudioSizeTime', 'SPPHRASERULE', 'SAFT32kHz8BitStereo',
    'DISPID_SRSSupportedLanguages', 'SPSHORTCUTTYPE',
    'DISPID_SVSInputWordLength', 'SPRST_ACTIVE',
    'DISPID_SpeechPhraseProperties', 'ISpPhoneticAlphabetSelection',
    'LONG_PTR', 'DISPID_SGRSTsCount', 'SECNormalConfidence',
    'DISPID_SpeechPhraseProperty', 'DISPID_SABIBufferSize',
    'ISpeechFileStream', 'DISPID_SRCEAdaptation',
    'DISPID_SRRSetTextFeedback', 'ISpeechRecoGrammar',
    'SpeechEngineProperties', 'SPRECOSTATE', 'SPWAVEFORMATTYPE',
    'SP_VISEME_15', 'SPAS_PAUSE', 'IEnumString', 'SpeechInterference',
    'DISPID_SRGSetTextSelection', 'SDKLDefaultLocation',
    'SPPROPERTYINFO', 'DISPID_SGRAddState',
    'SPEI_PROPERTY_NUM_CHANGE', 'SP_VISEME_5', 'SAFT24kHz8BitStereo',
    'DISPID_SVEVoiceChange', 'SVP_7', 'SPEI_REQUEST_UI',
    'DISPID_SpeechBaseStream', 'DISPID_SVPriority', 'SPGRAMMARSTATE',
    'SPEI_UNDEFINED', 'SVP_15', 'ISpRecognizer', 'SPSHT_EMAIL',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SPIGetDisplayAttributes', 'SVP_12',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechRecoResultTimes', 'SVF_None', 'SPWF_INPUT',
    'DISPID_SPCPhoneToId', 'SPWORDPRONUNCIATION',
    'SpObjectTokenCategory', 'Speech_StreamPos_Asap',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCEPropertyStringChange', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechVoice', 'eLEXTYPE_PRIVATE20', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT16kHz8BitStereo', 'ISpMMSysAudio', 'SPSTREAMFORMATTYPE',
    'SpMMAudioIn', 'DISPID_SRCEventInterests', 'SpMemoryStream',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SGRSTWeight',
    'DISPID_SRSetPropertyString', 'SP_VISEME_6',
    'ISpeechPhraseElement', 'DISPID_SVEBookmark',
    'DISPID_SPPNumberOfElements'
]

_check_version('1.2.0', 1700235768.240296)
